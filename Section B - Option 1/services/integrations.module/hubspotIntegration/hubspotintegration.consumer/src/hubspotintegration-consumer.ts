...
import { HubspotIntegrationRepository } from './domain/repositories/hubspotintegration-repository';
import Configuration from './configuration.json';
import { ResponseStatus, HubspotIntegrationMessage } from '../../hubspotintegration.dto/src';
...
export class HubspotIntegrationConsumer{
    ...
    constructor() {
        ...
        const repository = new HubspotIntegrationRepository(this.config);
        this.aggregate = new HubspotIntegrationAggregate(repository);
    ...
    async consumeAsync(id: ObjectID, message: HubspotIntegrationMessage<HubspotIntegrationDataModel>): Promise<number> {
        try {
            ...
            const ERROR_MESSAGE = 'Error occurred while consuming message in HubspotIntegration consumer';
