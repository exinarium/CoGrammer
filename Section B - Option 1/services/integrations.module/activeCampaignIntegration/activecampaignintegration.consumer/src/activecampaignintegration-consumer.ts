...
import { ActiveCampaignIntegrationRepository } from './domain/repositories/activecampaignintegration-repository';
import Configuration from './configuration.json';
import { ResponseStatus, ActiveCampaignIntegrationMessage } from '../../activecampaignintegration.dto/src';
...
export class ActiveCampaignIntegrationConsumer{
    ...
    constructor() {
        ...
        const repository = new ActiveCampaignIntegrationRepository(this.config);
        this.aggregate = new ActiveCampaignIntegrationAggregate(repository);
    ...
    async consumeAsync(id: ObjectID, message: ActiveCampaignIntegrationMessage<ActiveCampaignIntegrationDataModel>): Promise<number> {
        try {
            ...
            const ERROR_MESSAGE = 'Error occurred while consuming message in ActiveCampaignIntegration consumer';
